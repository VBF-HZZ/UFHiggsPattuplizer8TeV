...
#      fi;
#      
#      if grep -q '60317\|8001\|8002\|60307\|8003\|8020\|8021\|60318\|70500\|10034\|8028\|10020\|10030\|10016' status.$d; then
#	  read -t7 -n1 -r -p "pausing..." key; echo;
#	  crab -c $d $(perl -e '
#    @a=();
#    while(<>){
#        ($j,$e) = m/^(\d+)\s+\S+\s+\S+\s+\S+\s+\S+\s+(?:60317|8001|8002|60307|7|9|8003|8020|8021|8028|60318|70500|10034|10020|10030|10016)\s+\S+/  or next;
#        push @a,$j; 
#    }
#    print "-resubmit " . join(",",@a) . " -GRID.ce_black_list cmsrm-ce01.roma1.infn.it,cmsrm-ce02.roma1.infn.it \n"' status.$d);
#      fi;
