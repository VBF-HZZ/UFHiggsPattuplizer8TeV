...
//
// $Id: MuonCleanerBySegments.cc,v 1.1 2012/10/13 00:07:28 snowball Exp $
//
...
/**
  ...
  \version  $Id: MuonCleanerBySegments.cc,v 1.1 2012/10/13 00:07:28 snowball Exp $
*/
...
modules::MuonCleanerBySegmentsT<T>::isBetterMuon(const T &mu1, const T &mu2) const {
    ...
    if ( (mu1.userInt("pfMuId") == 1)     != (mu2.userInt("pfMuId") ==1))     return (mu1.userInt("pfMuId")==1);
